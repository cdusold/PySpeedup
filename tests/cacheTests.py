...
class CacheTest(ut.TestCase):
    ...
    def test_fib(self):
        ...
        self.assertEqual(self.c(5),5,"The fifth element of the Fibonnaci sequence is 5, not {}.".format(str(self.c(5))))
        #self.assertRaises(f(-1)
    #def test_init(self): #TODO: redo for this.
        #self.assertEqual(len(self.c._d),0,"The cache was malformed.")
        #self.assertEqual(self.c.n,1,"The cache max size was not recorded properly.")
        #self.assertEqual(self.c._f(0),uncachedFib(0),"The function was not entered correctly.")
    def test_cache(self):
        i=self.c(0)
        self.assertEqual(len(self.c._d),1,"The value was not cached properly.")
        self.assertEqual(self.c(0),i,"The cached answer was incorrect.")
    #def test_pop(self): #TODO: pop? That's not a thing yet.
        #i=self.c(3)
        #self.assertEqual(len(self.c._d),3,"Recursion not properly set up for caching.")
        #i=self.c(4)
        #self.assertEqual(len(self.c.c),3,"Maximum cache size not implemented correctly.") #This feature doesn't exist (yet?)
    def test_speed(self):
        t1=None
        t2=None
        with Timer() as t1:
...
class bufferTest(ut.TestCase):
    ...
    def test_mPrimes(self):
        for i in range(100):
            self.assertEqual(next(self.primes),concurrent_sieve[i],"The buffer skipped prime number {}.".format(i))
    #def test_init(self): #TODO: redo for this.
        #self.assertEqual(len(self.c._d),0,"The cache was malformed.")
        #self.assertEqual(self.c.n,1,"The cache max size was not recorded properly.")
        #self.assertEqual(self.c._f(0),uncachedFib(0),"The function was not entered correctly.")
